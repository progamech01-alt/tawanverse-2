...
begin
 select id into admin_id from auth.users where lower(email)=lower('korrapat10392@gmail.com');
 select id into viewer_id from auth.users where lower(email)=lower('tawan@gmail.com');
